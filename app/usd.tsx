...
export default function Usd() {
    ...
    const [placeholder, setPlaceholder] = useState('Digite o Valor em Euro');
    ...
    function converter(): void{
        ...
        const convertido = Number(valor) * valorUsd;
    ...
    useEffect(() => {
        async function carregar() {           
            try {
                ...
                setValorUsd(Number(valor.toFixed(2)));
            } catch (error: any) {
    ...
    return (
        <View style={styles.container}>
            <View>
                <Text style={styles.texto}>Conversor USD → BRL</Text>
                <Text style={styles.subtexto}>$1 equivale a R${valorUsd.toFixed(2)}</Text>                
            </View>
            <View>
                <TextInput

...
export default function Eur(){
    ...
    const [placeholder, setPlaceholder] = useState('Digite o Valor em Dólar');
    ...
    function converter(): void{
        ...
        const convertido = Number(valor) * valorEur;
    ...
    useEffect(()=>{
        ...
        async function carregar(){
            try{
                ...
                setValorEur(Number(valor.toFixed(2)));
            }catch (error:any){
    ...
    return(
         <View style={styles.container}>
                    <View>
                        <Text style={styles.texto}>Conversor EUR → BRL</Text>
                        <Text style={styles.subtexto}>€1 equivale a R${valorEur.toFixed(2)}</Text>                
                    </View>
                    <View>
                        <TextInput
